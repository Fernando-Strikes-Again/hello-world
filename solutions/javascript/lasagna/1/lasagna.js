...
export function remainingMinutesInOven(actualMinutesInOven) {
  const remainingMinutesInOven = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
...
export function preparationTimeInMinutes(numberOfLayers) {
  const preparationTimeInMinutes = PREPARATION_MINUTES_PER_LAYER * numberOfLayers;
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  const totalTimeInMinutes = preparationTimeInMinutes(numberOfLayers) + actualMinutesInOven;
